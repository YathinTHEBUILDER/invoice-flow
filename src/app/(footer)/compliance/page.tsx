    ...
    <div className="space-y-16">
      ...
      <div className="grid sm:grid-cols-2 gap-8">
        {[
          ...
          <div key={i} className="glass-dark rounded-2xl p-8 space-y-6">
      ...
      <div className="glass-dark rounded-2xl p-8 md:p-12">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="space-y-6 flex-1">
            <h2 className="text-2xl font-bold tracking-tight text-white">Certification & Audits</h2>
            ...
            <div className="flex gap-4">
              <div className="px-4 py-2 rounded-lg bg-emerald-500/10 text-emerald-500 text-[10px] font-black uppercase tracking-widest border border-emerald-500/20">ISO 27001 Certified</div>
              <div className="px-4 py-2 rounded-lg bg-blue-500/10 text-blue-500 text-[10px] font-black uppercase tracking-widest border border-blue-500/20">SOC2 Type II Verified</div>
            </div>
          </div>
