    ...
    <div className="space-y-16">
      ...
      <div className="grid sm:grid-cols-2 gap-8">
        {[
          {
            title: "KYC & AML",
            desc: "Rigorous Know Your Customer (KYC) and Anti-Money Laundering (AML) checks for all participants.",
            icon: Users
          },
          {
            title: "Data Protection",
            desc: "Full compliance with the Digital Personal Data Protection Act (DPDP) and industry-best encryption.",
            icon: Lock
          },
          {
            title: "Legal Framework",
            desc: "Operating within the valid legal framework for invoice discounting and peer-to-peer facilitation in India.",
            icon: Scale
          },
          {
            title: "Fair Practices",
            desc: "Adherence to fair practice codes, ensuring transparency in fees, risks, and settlement processes.",
            icon: ShieldCheck
          }
        ].map((item, i) => (
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="space-y-6 flex-1">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We undergo regular third-party security audits and financial compliance reviews to ensure our systems remain bulletproof and our processes stay transparent.
            </p>
            <div className="flex gap-4">
              ...
              <div className="px-4 py-2 rounded-lg bg-blue-500/10 text-blue-500 text-xs font-black uppercase tracking-widest border border-blue-500/20">SOC2 Type II Compliant</div>
            </div>
          </div>
...
// Dummy Users icon since it wasn't imported
